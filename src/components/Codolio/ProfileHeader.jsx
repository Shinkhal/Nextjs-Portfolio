      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex space-x-3 mt-4">
          ...
          {userDetails?.githubProfile && (
            <a href={`https://github.com/${userDetails.githubProfile}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
...
function SocialMediaLink({ social }) {
  const icons = {
    linkedIn: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  let href = social.handle;
  if (social.socialMediaPlatform === 'linkedIn' && !href.startsWith('http')) {
    href = `https://linkedin.com/in/${href}`;
  }
  if (social.socialMediaPlatform === 'twitter' && !href.startsWith('http')) {
  ...
  return (
    ...
    >
      {icons[social.socialMediaPlatform] || social.socialMediaPlatform}
    </a>
  );
}